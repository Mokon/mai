...
namespace Net.Mokon.Edu.Unh.CS.AI.Search.Algorithms.RealTime {
  ...
  /// </summary>
  public class BRTSwAStar<SS, DS> : BRTS<SS, DS>
    ...
    public BRTSwAStar( Heuristic<SS, DS> Heuristic,
      Transformer<SS, DS> Transformer, Metric Weight ) 
      : base( Heuristic, false, Transformer ) {
      throw new Exception( "Not Implemented Weight" );
    }
