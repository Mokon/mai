...
export Algs="4\
 RealTimeAnytimeD*-LSS-LRTA*-Goal-Ratio=0.25\
 RealTimeAnytimeD*-LSS-LRTA*-Goal-Ratio=0.50\
 RealTimeAnytimeD*-LSS-LRTA*-Goal-Ratio=0.75\
 RealTimeAnytimeD*-LSS-LRTA*-Goal-Ratio=0.90\
"
