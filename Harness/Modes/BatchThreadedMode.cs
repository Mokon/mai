...
namespace Net.Mokon.Edu.Unh.CS.AI.Harness {
  ...
  /// </summary>
  public class BatchModeThreaded : AbstractBatchMode {

    public override string GetHelp( ) {
      return "Runs batch mode with threading on many setting, maps, and algorithms.";
    }
    ...
    /// </summary>
    public BatchModeThreaded( ) {
      base.CLH.AddFlags( new CommandLineFlag( this, "The base input dir.", "dir", "d", "dir" ),
        new TruncOrCreateNewAutoFlushTextWriterFlag( this, "The base output file.", "Out", "o", "output" )
      );
    }
